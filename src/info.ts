 ...
 * @returns `true` if a document with the given ID is present in the index and available for search,
 *   `false` otherwise
 */
...
/**
 * Returns the stored fields (as configured in the `storeFields` constructor option) for the given
 * document ID. Returns `undefined` if the document is not present in the index.
 *
 * @typeParam ID The id type of the documents being indexed.
 * @typeParam Document The type of the documents being indexed.
 * @typeParam Index The type of the documents being indexed.
