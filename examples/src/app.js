...
class App extends React.PureComponent {
  ...
  getSuggestions(query) {
    const { miniSearch } = this.state;
    return miniSearch
      .autoSuggest(query, { boost: { artist: 5 } })
...
const Explanation = () => (
  <p>
    ...
    <a href="https://github.com/lucaong/minisearch">MiniSearch</a> JavaScript
    library: try searching through more than 5000 top songs and artists in{" "}
    <em>Billboard Hot 100</em> from year 1965 to 2015. This example demonstrates
    search (with prefix and fuzzy match) and auto-completion.
  </p>
);
